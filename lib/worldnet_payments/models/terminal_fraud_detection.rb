...
module WorldnetPayments
  # Terminal fraud detection tools.
  class TerminalFraudDetection
    # Indicates whether cardholder signature requirement should be relaxed.
    attr_accessor :allow_cardholder_signature_bypass

    # Indicates whether the terminal allows unreferenced refunds.<br />This type of refunds do not require a prior payment transaction to be referenced.
    attr_accessor :allow_unreferenced_refunds

    # Amount threshold for unreferenced refunds.
    attr_accessor :unreferenced_refund_amount_limit

    # The percentage limit for referenced refunds. This is usually configured at 100% of the original transaction's amount.
    attr_accessor :refund_percentage_limit

    attr_accessor :address_verification

    attr_accessor :cvv_verification
    ...
    def self.openapi_types
      {
        :'allow_cardholder_signature_bypass' => :'Boolean',
        :'allow_unreferenced_refunds' => :'Boolean',
        :'unreferenced_refund_amount_limit' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::TerminalFraudDetection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::TerminalFraudDetection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allow_cardholder_signature_bypass')
        self.allow_cardholder_signature_bypass = attributes[:'allow_cardholder_signature_bypass']
      end

      if attributes.key?(:'allow_unreferenced_refunds')
        self.allow_unreferenced_refunds = attributes[:'allow_unreferenced_refunds']
      end

      if attributes.key?(:'unreferenced_refund_amount_limit')
        self.unreferenced_refund_amount_limit = attributes[:'unreferenced_refund_amount_limit']
      end

      if attributes.key?(:'refund_percentage_limit')
        self.refund_percentage_limit = attributes[:'refund_percentage_limit']
      end
      ...
      if attributes.key?(:'cvv_verification')
        self.cvv_verification = attributes[:'cvv_verification']
      end
    ...
    def list_invalid_properties
      ...
      if @allow_cardholder_signature_bypass.nil?
        invalid_properties.push('invalid value for "allow_cardholder_signature_bypass", allow_cardholder_signature_bypass cannot be nil.')
      end

      if @allow_unreferenced_refunds.nil?
        invalid_properties.push('invalid value for "allow_unreferenced_refunds", allow_unreferenced_refunds cannot be nil.')
      end

      if @unreferenced_refund_amount_limit.nil?
        invalid_properties.push('invalid value for "unreferenced_refund_amount_limit", unreferenced_refund_amount_limit cannot be nil.')
      end

      if @refund_percentage_limit.nil?
        invalid_properties.push('invalid value for "refund_percentage_limit", refund_percentage_limit cannot be nil.')
      end
    ...
    def valid?
      return false if @allow_cardholder_signature_bypass.nil?
      return false if @allow_unreferenced_refunds.nil?
      return false if @unreferenced_refund_amount_limit.nil?
      return false if @refund_percentage_limit.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_cardholder_signature_bypass == o.allow_cardholder_signature_bypass &&
          allow_unreferenced_refunds == o.allow_unreferenced_refunds &&
          unreferenced_refund_amount_limit == o.unreferenced_refund_amount_limit &&
          refund_percentage_limit == o.refund_percentage_limit &&
          address_verification == o.address_verification &&
          cvv_verification == o.cvv_verification &&
    ...
    def hash
      [allow_cardholder_signature_bypass, allow_unreferenced_refunds, unreferenced_refund_amount_limit, refund_percentage_limit, address_verification, cvv_verification, three_d_secure].hash
    end
