...
module WorldnetPayments
  ...
  class MerchantDetails
    # Merchant's DBA (Doing Business As). This information will appear on transaction receipts.
    attr_accessor :name

    # Merchant Category Code. It is a four-digit number listed in ISO 18245 for retail financial services. An MCC is used to classify a business by the types of goods or services it provides.
    attr_accessor :mcc

    # Merchant's phone number. This information will appear on transaction receipts.
    attr_accessor :phone

    # Merchant's email address. This information will appear on transaction receipts.
    attr_accessor :email

    # Merchant's web page. This information will appear on transaction receipts.
    attr_accessor :website

    attr_accessor :address

    # List of merchant-level volume limits.
    attr_accessor :merchant_volume_limits
    ...
    def self.attribute_map
      {
        ...
        :'website' => :'website',
        :'address' => :'address',
        :'merchant_volume_limits' => :'merchantVolumeLimits'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'website' => :'String',
        :'address' => :'Address',
        :'merchant_volume_limits' => :'Array<MerchantLevelLimit>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::MerchantDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::MerchantDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_volume_limits')
        if (value = attributes[:'merchant_volume_limits']).is_a?(Array)
          self.merchant_volume_limits = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @mcc.to_s.length < 4
        invalid_properties.push('invalid value for "mcc", the character length must be great than or equal to 4.')
      end
    ...
    def valid?
      ...
      return false if @mcc.to_s.length < 4
      return false if @mcc !~ Regexp.new(/^[0-9]*$/)
      return false if @phone.nil?
      return false if @phone.to_s.length > 100
    ...
    def mcc=(mcc)
      ...
      if mcc.to_s.length < 4
        fail ArgumentError, 'invalid value for "mcc", the character length must be great than or equal to 4.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          website == o.website &&
          address == o.address &&
          merchant_volume_limits == o.merchant_volume_limits
    end
    ...
    def hash
      [name, mcc, phone, email, website, address, merchant_volume_limits].hash
    end
