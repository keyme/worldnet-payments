...
module WorldnetPayments
  # List of terminal-level and card-level volume limits.
  class TerminalVolumeLimits
    # Indicates whether the terminal has any terminal-level limits enabled.
    attr_accessor :enable_terminal_level_limits

    # List of terminal-level volume limits.
    attr_accessor :terminal_level_limits

    # Indicates whether the terminal has any card-level limits enabled.
    attr_accessor :enable_card_level_limits

    # List of card-level volume limits.
    attr_accessor :card_level_limits
    ...
    def self.openapi_types
      {
        :'enable_terminal_level_limits' => :'Boolean',
        :'terminal_level_limits' => :'Array<TerminalLevelLimit>',
        :'enable_card_level_limits' => :'Boolean',
        :'card_level_limits' => :'Array<CardLevelLimit>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::TerminalVolumeLimits` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::TerminalVolumeLimits`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'enable_terminal_level_limits')
        self.enable_terminal_level_limits = attributes[:'enable_terminal_level_limits']
      end

      if attributes.key?(:'terminal_level_limits')
        if (value = attributes[:'terminal_level_limits']).is_a?(Array)
          self.terminal_level_limits = value
        end
      end

      if attributes.key?(:'enable_card_level_limits')
        self.enable_card_level_limits = attributes[:'enable_card_level_limits']
      end

      if attributes.key?(:'card_level_limits')
        if (value = attributes[:'card_level_limits']).is_a?(Array)
          self.card_level_limits = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @enable_terminal_level_limits.nil?
        invalid_properties.push('invalid value for "enable_terminal_level_limits", enable_terminal_level_limits cannot be nil.')
      end

      if @enable_card_level_limits.nil?
        invalid_properties.push('invalid value for "enable_card_level_limits", enable_card_level_limits cannot be nil.')
      end
    ...
    def valid?
      return false if @enable_terminal_level_limits.nil?
      return false if @enable_card_level_limits.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable_terminal_level_limits == o.enable_terminal_level_limits &&
          terminal_level_limits == o.terminal_level_limits &&
          enable_card_level_limits == o.enable_card_level_limits &&
          card_level_limits == o.card_level_limits
    end
    ...
    def hash
      [enable_terminal_level_limits, terminal_level_limits, enable_card_level_limits, card_level_limits].hash
    end
