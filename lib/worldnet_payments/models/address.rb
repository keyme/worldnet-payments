...
module WorldnetPayments
  class Address
    # The first line of the address.<br />This field is used for AVS checks along with `city` and `postalCode`.
    attr_accessor :line1
    ...
    # The two-letter country code defined by [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) standard.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::Address` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::Address`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@line1.nil? && @line1.to_s.length > 50
        invalid_properties.push('invalid value for "line1", the character length must be smaller than or equal to 50.')
      end

      if !@line1.nil? && @line1.to_s.length < 0
        invalid_properties.push('invalid value for "line1", the character length must be great than or equal to 0.')
      end
      ...
      if !@city.nil? && @city.to_s.length > 128
        invalid_properties.push('invalid value for "city", the character length must be smaller than or equal to 128.')
      end
      ...
      if !@state.nil? && @state.to_s.length > 128
    ...
    def valid?
      return false if !@line1.nil? && @line1.to_s.length > 50
      return false if !@line1.nil? && @line1.to_s.length < 0
      ...
      return false if !@city.nil? && @city.to_s.length > 128
      return false if !@city.nil? && @city.to_s.length < 0
      return false if !@state.nil? && @state.to_s.length > 128
    ...
    def line1=(line1)
      ...
      if !line1.nil? && line1.to_s.length < 0
        fail ArgumentError, 'invalid value for "line1", the character length must be great than or equal to 0.'
      end
    ...
    def city=(city)
      if !city.nil? && city.to_s.length > 128
        fail ArgumentError, 'invalid value for "city", the character length must be smaller than or equal to 128.'
      end
    ...
    def hash
      [line1, line2, postal_code, city, state, country].hash
    end
