  ...
  class CredentialOnFile
    ...
    def self.attribute_map
      {
        ...
        :'usage_agreement' => :'usageAgreement'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::CredentialOnFile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::CredentialOnFile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'usage_agreement')
        self.usage_agreement = attributes[:'usage_agreement']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tokenize.nil?
        invalid_properties.push('invalid value for "tokenize", tokenize cannot be nil.')
      end
    ...
    def valid?
      ...
      usage_agreement_validator = EnumAttributeValidator.new('String', ["UNSCHEDULED", "RECURRING", "INSTALLMENT"])
      return false unless usage_agreement_validator.valid?(@usage_agreement)
      true
    end
    ...
    # @param [Object] usage_agreement Object to be assigned
    def usage_agreement=(usage_agreement)
      validator = EnumAttributeValidator.new('String', ["UNSCHEDULED", "RECURRING", "INSTALLMENT"])
      unless validator.valid?(usage_agreement)
        fail ArgumentError, "invalid value for \"usage_agreement\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          usage_agreement == o.usage_agreement
    end
    ...
    def hash
      [tokenize, merchant_reference, usage_agreement].hash
    end
