...
module WorldnetPayments
  class PartiallyEncryptedKeyedDataFormat < KeyedDataFormat
    attr_accessor :device

    # The primary account number (PAN) / card number encrypted by the device.
    attr_accessor :encrypted_pan

    # The card number masked with the character `*`.<br />According to PCI DSS, only the first six and last four digits may be displayed. For example: `548010******5929`
    ...
    # The CVV data encrypted by the device.
    attr_accessor :cvv_encrypted
    ...
    def self.openapi_all_of
      [
      :'KeyedDataFormat',
      :'PartiallyEncryptedKeyedDataFormatAllOf'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::PartiallyEncryptedKeyedDataFormat` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::PartiallyEncryptedKeyedDataFormat`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'encrypted_pan')
        self.encrypted_pan = attributes[:'encrypted_pan']
      end
      ...
      if attributes.key?(:'cvv_encrypted')
        self.cvv_encrypted = attributes[:'cvv_encrypted']
      end
    ...
    def list_invalid_properties
      ...
      if @encrypted_pan.nil?
        invalid_properties.push('invalid value for "encrypted_pan", encrypted_pan cannot be nil.')
      end
      ...
      if !@cvv.nil? && @cvv !~ pattern
        invalid_properties.push("invalid value for \"cvv\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/[0-9]{1,2}/)
      if !@issue_number.nil? && @issue_number !~ pattern
        invalid_properties.push("invalid value for \"issue_number\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @encrypted_pan.nil?
      ...
      return false if @expiry_date !~ Regexp.new(/[0-9]{4}/)
      return false if !@cvv.nil? && @cvv !~ Regexp.new(/[0-9]{3,4}/)
      return false if !@issue_number.nil? && @issue_number !~ Regexp.new(/[0-9]{1,2}/)
      true && super
    end
    ...
    def issue_number=(issue_number)
      pattern = Regexp.new(/[0-9]{1,2}/)
      if !issue_number.nil? && issue_number !~ pattern
        fail ArgumentError, "invalid value for \"issue_number\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          device == o.device &&
          encrypted_pan == o.encrypted_pan &&
          masked_pan == o.masked_pan &&
          expiry_date == o.expiry_date &&
          cvv == o.cvv &&
          cvv_encrypted == o.cvv_encrypted &&
          issue_number == o.issue_number && super(o)
    end
    ...
    def hash
      [device, encrypted_pan, masked_pan, expiry_date, cvv, cvv_encrypted, issue_number].hash
    end
