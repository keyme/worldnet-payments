  ...
  class TransactionReceipt
    ...
    def self.openapi_types
      {
        :'copy' => :'String',
        :'header' => :'String',
        :'merchant_details' => :'Array<ReceiptOrderedInfo>',
        :'transaction_data' => :'Array<ReceiptOrderedInfo>',
        :'custom_fields' => :'Array<CustomField>',
        :'icc_data' => :'Array<ReceiptOrderedInfo>',
        :'footer' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::TransactionReceipt` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::TransactionReceipt`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_details')
        if (value = attributes[:'merchant_details']).is_a?(Array)
          self.merchant_details = value
        end
      end

      if attributes.key?(:'transaction_data')
        if (value = attributes[:'transaction_data']).is_a?(Array)
      ...
      if attributes.key?(:'icc_data')
        if (value = attributes[:'icc_data']).is_a?(Array)
          self.icc_data = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @copy.nil?
        invalid_properties.push('invalid value for "copy", copy cannot be nil.')
      end
      ...
      if @merchant_details.nil?
        invalid_properties.push('invalid value for "merchant_details", merchant_details cannot be nil.')
      end
      ...
      if @icc_data.nil?
        invalid_properties.push('invalid value for "icc_data", icc_data cannot be nil.')
      end
    ...
    def valid?
      ...
      copy_validator = EnumAttributeValidator.new('String', ["CARDHOLDER_COPY", "CARD_ACCEPTOR_COPY"])
      return false unless copy_validator.valid?(@copy)
      return false if @header.nil?
      return false if @merchant_details.nil?
      return false if @transaction_data.nil?
      return false if @custom_fields.nil?
      return false if @icc_data.nil?
      return false if @footer.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] copy Object to be assigned
    def copy=(copy)
      validator = EnumAttributeValidator.new('String', ["CARDHOLDER_COPY", "CARD_ACCEPTOR_COPY"])
      unless validator.valid?(copy)
        fail ArgumentError, "invalid value for \"copy\", must be one of #{validator.allowable_values}."
      end
      @copy = copy
    end
    ...
    def hash
      [copy, header, merchant_details, transaction_data, custom_fields, icc_data, footer, terms_and_conditions].hash
    end
