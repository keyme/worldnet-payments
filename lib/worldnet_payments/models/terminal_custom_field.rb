...
module WorldnetPayments
  ...
  class TerminalCustomField
    # The type of the data the custom field is configured to carry.
    attr_accessor :type

    # Custom field name assigned by the merchant.
    attr_accessor :name

    # Friendly name that should be used for receipts and pages.
    attr_accessor :display_name

    # Position of the field in relation to other custom fields.
    attr_accessor :display_order

    # Indicates whether the custom field should be shown on hosted pages.
    attr_accessor :payment_page

    # Indicates whether the custom field should be considered for Subscriptions which is our payment plan / standing order mechanism.
    attr_accessor :subscription

    # Indicates whether the custom field will **only** serve the purpose of adding additional information to secure cards or accounts.
    attr_accessor :secure_credentials_only

    # If enabled, it ensures that a transaction will never be processed without the custom field properly populated.
    ...
    def self.openapi_types
      {
        ...
        :'secure_credentials_only' => :'Boolean',
        :'mandatory' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::TerminalCustomField` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::TerminalCustomField`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_page')
        self.payment_page = attributes[:'payment_page']
      end
      ...
      if attributes.key?(:'secure_credentials_only')
        self.secure_credentials_only = attributes[:'secure_credentials_only']
      end
    ...
    def list_invalid_properties
      ...
      if @type.to_s.length > 2147483647
        invalid_properties.push('invalid value for "type", the character length must be smaller than or equal to 2147483647.')
      end
      ...
      if @name.to_s.length > 2147483647
        invalid_properties.push('invalid value for "name", the character length must be smaller than or equal to 2147483647.')
      end
      ...
      if @display_name.to_s.length > 2147483647
        invalid_properties.push('invalid value for "display_name", the character length must be smaller than or equal to 2147483647.')
      end
      ...
      if @payment_page.nil?
        invalid_properties.push('invalid value for "payment_page", payment_page cannot be nil.')
      end
      ...
      if @secure_credentials_only.nil?
        invalid_properties.push('invalid value for "secure_credentials_only", secure_credentials_only cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["STRING", "NUMERIC", "BOOLEAN"])
      return false unless type_validator.valid?(@type)
      return false if @type.to_s.length > 2147483647
      return false if @type.to_s.length < 1
      return false if @name.nil?
      return false if @name.to_s.length > 2147483647
      return false if @name.to_s.length < 1
      return false if @display_name.nil?
      return false if @display_name.to_s.length > 2147483647
      return false if @display_name.to_s.length < 1
      return false if @display_order.nil?
      return false if @payment_page.nil?
      return false if @subscription.nil?
      return false if @secure_credentials_only.nil?
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["STRING", "NUMERIC", "BOOLEAN"])
    ...
    def name=(name)
      ...
      if name.to_s.length > 2147483647
        fail ArgumentError, 'invalid value for "name", the character length must be smaller than or equal to 2147483647.'
      end
    ...
    def display_name=(display_name)
      ...
      if display_name.to_s.length > 2147483647
        fail ArgumentError, 'invalid value for "display_name", the character length must be smaller than or equal to 2147483647.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_page == o.payment_page &&
          subscription == o.subscription &&
          secure_credentials_only == o.secure_credentials_only &&
    ...
    def hash
      [type, name, display_name, display_order, payment_page, subscription, secure_credentials_only, mandatory].hash
    end
