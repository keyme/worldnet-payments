...
module WorldnetPayments
  # Terminal supported features.
  class TerminalFeatures
    # Indicates whether the terminal allows offline sales.
    attr_accessor :allow_offline_sales

    # Indicates whether the terminal allows partial refunds.
    attr_accessor :allow_partial_refund

    # Indicates whether the terminal is able to process taxes.
    attr_accessor :allow_tax

    # Indicates whether the terminal is able to process tips.
    attr_accessor :allow_tip

    # Indicates whether the terminal is able to handle digital wallet payloads from Google Pay.
    attr_accessor :allow_google_pay

    # Indicates whether the terminal is able to handle digital wallet payloads from Apple Pay.
    attr_accessor :allow_apple_pay

    # Indicates whether the terminal is able to handle card payloads from EMV devices.
    attr_accessor :allow_emv

    # Indicates whether the terminal is able to handle manually keyed card details.
    attr_accessor :allow_keyed

    # Indicates whether the terminal is able to handle card payloads from MSR devices.
    attr_accessor :allow_mag_stripe

    # Indicates whether the terminal allows transactions to fallback to swipe method due to chip card reader failures.
    attr_accessor :allow_mag_stripe_fallback

    attr_accessor :secure_credentials
    ...
    def self.openapi_types
      {
        ...
        :'allow_emv' => :'Boolean',
        :'allow_keyed' => :'Boolean',
        :'allow_mag_stripe' => :'Boolean',
        :'allow_mag_stripe_fallback' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::TerminalFeatures` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::TerminalFeatures`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allow_offline_sales')
        self.allow_offline_sales = attributes[:'allow_offline_sales']
      end

      if attributes.key?(:'allow_partial_refund')
        self.allow_partial_refund = attributes[:'allow_partial_refund']
      end

      if attributes.key?(:'allow_tax')
        self.allow_tax = attributes[:'allow_tax']
      end

      if attributes.key?(:'allow_tip')
        self.allow_tip = attributes[:'allow_tip']
      end

      if attributes.key?(:'allow_google_pay')
        self.allow_google_pay = attributes[:'allow_google_pay']
      end

      if attributes.key?(:'allow_apple_pay')
        self.allow_apple_pay = attributes[:'allow_apple_pay']
      end

      if attributes.key?(:'allow_emv')
        self.allow_emv = attributes[:'allow_emv']
      end

      if attributes.key?(:'allow_keyed')
        self.allow_keyed = attributes[:'allow_keyed']
      end

      if attributes.key?(:'allow_mag_stripe')
        self.allow_mag_stripe = attributes[:'allow_mag_stripe']
      end

      if attributes.key?(:'allow_mag_stripe_fallback')
        self.allow_mag_stripe_fallback = attributes[:'allow_mag_stripe_fallback']
      end

      if attributes.key?(:'secure_credentials')
        self.secure_credentials = attributes[:'secure_credentials']
      end
    ...
    def list_invalid_properties
      ...
      if @allow_offline_sales.nil?
        invalid_properties.push('invalid value for "allow_offline_sales", allow_offline_sales cannot be nil.')
      end

      if @allow_partial_refund.nil?
        invalid_properties.push('invalid value for "allow_partial_refund", allow_partial_refund cannot be nil.')
      end

      if @allow_tax.nil?
        invalid_properties.push('invalid value for "allow_tax", allow_tax cannot be nil.')
      end

      if @allow_tip.nil?
        invalid_properties.push('invalid value for "allow_tip", allow_tip cannot be nil.')
      end

      if @allow_google_pay.nil?
        invalid_properties.push('invalid value for "allow_google_pay", allow_google_pay cannot be nil.')
      end

      if @allow_apple_pay.nil?
        invalid_properties.push('invalid value for "allow_apple_pay", allow_apple_pay cannot be nil.')
      end

      if @allow_emv.nil?
        invalid_properties.push('invalid value for "allow_emv", allow_emv cannot be nil.')
      end

      if @allow_keyed.nil?
        invalid_properties.push('invalid value for "allow_keyed", allow_keyed cannot be nil.')
      end

      if @allow_mag_stripe.nil?
        invalid_properties.push('invalid value for "allow_mag_stripe", allow_mag_stripe cannot be nil.')
      end

      if @allow_mag_stripe_fallback.nil?
        invalid_properties.push('invalid value for "allow_mag_stripe_fallback", allow_mag_stripe_fallback cannot be nil.')
      end
    ...
    def valid?
      return false if @allow_offline_sales.nil?
      return false if @allow_partial_refund.nil?
      return false if @allow_tax.nil?
      return false if @allow_tip.nil?
      return false if @allow_google_pay.nil?
      return false if @allow_apple_pay.nil?
      return false if @allow_emv.nil?
      return false if @allow_keyed.nil?
      return false if @allow_mag_stripe.nil?
      return false if @allow_mag_stripe_fallback.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_offline_sales == o.allow_offline_sales &&
          allow_partial_refund == o.allow_partial_refund &&
          allow_tax == o.allow_tax &&
          allow_tip == o.allow_tip &&
          allow_google_pay == o.allow_google_pay &&
          allow_apple_pay == o.allow_apple_pay &&
          allow_emv == o.allow_emv &&
          allow_keyed == o.allow_keyed &&
          allow_mag_stripe == o.allow_mag_stripe &&
          allow_mag_stripe_fallback == o.allow_mag_stripe_fallback &&
          secure_credentials == o.secure_credentials &&
    ...
    def hash
      [allow_offline_sales, allow_partial_refund, allow_tax, allow_tip, allow_google_pay, allow_apple_pay, allow_emv, allow_keyed, allow_mag_stripe, allow_mag_stripe_fallback, secure_credentials, surcharge].hash
    end
