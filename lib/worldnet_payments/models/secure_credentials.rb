...
module WorldnetPayments
  # The secure credentials containing the customer's account details stored as part of the authorization.  **Note:** Automatic tokenization feature is optional and it is not available for all accounts. Therefore, merchants who are interested in having this feature must get in touch with our support team to check availability.
  class SecureCredentials
    # The terminal which is the credentials' owner. It means that even though the credentials can be shared to perform transactions, update and delete operations can only be requested by owners.
    attr_accessor :terminal

    # Unique merchant reference that identifies the stored credentials on both merchant's and gateway's sides.  **Note:** Clients must be able to store this value in order to eventually retrieve, update and delete the stored credentials.
    ...
    attr_accessor :credentials_number

    # The number of the tokenized card/account masked as per PCI requirements.
    ...
    attr_accessor :security_check

    # List of custom fields representing the additional information sent by the merchant and stored along with the credentials.
    attr_accessor :additional_data_fields

    # List of hypermedia links containing the operations available for the resource.
    attr_accessor :links
    ...
    def self.openapi_types
      {
        ...
        :'credentials_number' => :'String',
        :'masked_pan' => :'String',
        :'security_check' => :'String',
        :'additional_data_fields' => :'Array<CustomField>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::SecureCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::SecureCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credentials_number')
        self.credentials_number = attributes[:'credentials_number']
      end
      ...
      if attributes.key?(:'security_check')
        self.security_check = attributes[:'security_check']
      end

      if attributes.key?(:'additional_data_fields')
        if (value = attributes[:'additional_data_fields']).is_a?(Array)
          self.additional_data_fields = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @terminal.to_s.length > 50
        invalid_properties.push('invalid value for "terminal", the character length must be smaller than or equal to 50.')
      end

      if @terminal.to_s.length < 1
        invalid_properties.push('invalid value for "terminal", the character length must be great than or equal to 1.')
      end
      ...
      if @merchant_reference.to_s.length > 48
        invalid_properties.push('invalid value for "merchant_reference", the character length must be smaller than or equal to 48.')
      end

      if @merchant_reference.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_reference", the character length must be great than or equal to 1.')
      end

      if @credentials_number.nil?
        invalid_properties.push('invalid value for "credentials_number", credentials_number cannot be nil.')
      end

      if @credentials_number.to_s.length > 19
        invalid_properties.push('invalid value for "credentials_number", the character length must be smaller than or equal to 19.')
      end

      if @credentials_number.to_s.length < 12
        invalid_properties.push('invalid value for "credentials_number", the character length must be great than or equal to 12.')
      end
      ...
      if @masked_pan.to_s.length > 19
        invalid_properties.push('invalid value for "masked_pan", the character length must be smaller than or equal to 19.')
      end

      if @masked_pan.to_s.length < 12
        invalid_properties.push('invalid value for "masked_pan", the character length must be great than or equal to 12.')
      end
    ...
    def valid?
      ...
      return false if @terminal.to_s.length > 50
      return false if @terminal.to_s.length < 1
      return false if @merchant_reference.nil?
      return false if @merchant_reference.to_s.length > 48
      return false if @merchant_reference.to_s.length < 1
      return false if @credentials_number.nil?
      return false if @credentials_number.to_s.length > 19
      return false if @credentials_number.to_s.length < 12
      return false if @masked_pan.nil?
      return false if @masked_pan.to_s.length > 19
      return false if @masked_pan.to_s.length < 12
      security_check_validator = EnumAttributeValidator.new('String', ["NOT_VALIDATED", "CVV_VALIDATED", "ISSUE_NO_VALIDATED", "VALIDATION_FAILED", "CARD_NUMBER_VALIDATED"])
      return false unless security_check_validator.valid?(@security_check)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] terminal Value to be assigned
    def terminal=(terminal)
      if terminal.nil?
        fail ArgumentError, 'terminal cannot be nil'
      end

      if terminal.to_s.length > 50
        fail ArgumentError, 'invalid value for "terminal", the character length must be smaller than or equal to 50.'
      end

      if terminal.to_s.length < 1
        fail ArgumentError, 'invalid value for "terminal", the character length must be great than or equal to 1.'
      end
    ...
    def merchant_reference=(merchant_reference)
      ...
      if merchant_reference.to_s.length > 48
        fail ArgumentError, 'invalid value for "merchant_reference", the character length must be smaller than or equal to 48.'
      end

      if merchant_reference.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_reference", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] credentials_number Value to be assigned
    def credentials_number=(credentials_number)
      if credentials_number.nil?
        fail ArgumentError, 'credentials_number cannot be nil'
      end

      if credentials_number.to_s.length > 19
        fail ArgumentError, 'invalid value for "credentials_number", the character length must be smaller than or equal to 19.'
      end

      if credentials_number.to_s.length < 12
        fail ArgumentError, 'invalid value for "credentials_number", the character length must be great than or equal to 12.'
      end
    ...
    def masked_pan=(masked_pan)
      ...
      if masked_pan.to_s.length > 19
        fail ArgumentError, 'invalid value for "masked_pan", the character length must be smaller than or equal to 19.'
      end

      if masked_pan.to_s.length < 12
        fail ArgumentError, 'invalid value for "masked_pan", the character length must be great than or equal to 12.'
      end
    ...
    # @param [Object] security_check Object to be assigned
    def security_check=(security_check)
      validator = EnumAttributeValidator.new('String', ["NOT_VALIDATED", "CVV_VALIDATED", "ISSUE_NO_VALIDATED", "VALIDATION_FAILED", "CARD_NUMBER_VALIDATED"])
      unless validator.valid?(security_check)
        fail ArgumentError, "invalid value for \"security_check\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credentials_number == o.credentials_number &&
          masked_pan == o.masked_pan &&
          security_check == o.security_check &&
          additional_data_fields == o.additional_data_fields &&
          links == o.links
    end
    ...
    def hash
      [terminal, merchant_reference, credentials_number, masked_pan, security_check, additional_data_fields, links].hash
    end
