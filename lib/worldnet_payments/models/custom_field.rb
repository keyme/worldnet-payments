  ...
  class CustomField
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::CustomField` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::CustomField`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @name.to_s.length > 56
        invalid_properties.push('invalid value for "name", the character length must be smaller than or equal to 56.')
      end
      ...
      if @value.to_s.length > 2147483647
        invalid_properties.push('invalid value for "value", the character length must be smaller than or equal to 2147483647.')
      end
    ...
    def valid?
      ...
      return false if @name.to_s.length > 56
      return false if @name.to_s.length < 1
      return false if @value.nil?
      return false if @value.to_s.length > 2147483647
    ...
    def name=(name)
      ...
      if name.to_s.length > 56
        fail ArgumentError, 'invalid value for "name", the character length must be smaller than or equal to 56.'
      end
    ...
    def value=(value)
      ...
      if value.to_s.length > 2147483647
        fail ArgumentError, 'invalid value for "value", the character length must be smaller than or equal to 2147483647.'
      end
