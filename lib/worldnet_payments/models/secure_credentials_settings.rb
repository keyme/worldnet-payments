...
module WorldnetPayments
  class SecureCredentialsSettings
    # Indicates whether the terminal supports secure credentials which is our tokenization mechanism for cards and accounts.
    attr_accessor :enable

    # Indicates that account verifications will be performed when the secure code (CVV) is provided during Secure Card registrations.
    attr_accessor :enable_secure_card_validation

    # Indicates that account verifications are mandatory for all Secure Card registrations.
    attr_accessor :force_secure_card_validation
    ...
    def self.openapi_types
      {
        :'enable' => :'Boolean',
        :'enable_secure_card_validation' => :'Boolean',
        :'force_secure_card_validation' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::SecureCredentialsSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::SecureCredentialsSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enable_secure_card_validation')
        self.enable_secure_card_validation = attributes[:'enable_secure_card_validation']
      end

      if attributes.key?(:'force_secure_card_validation')
        self.force_secure_card_validation = attributes[:'force_secure_card_validation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @enable_secure_card_validation.nil?
        invalid_properties.push('invalid value for "enable_secure_card_validation", enable_secure_card_validation cannot be nil.')
      end

      if @force_secure_card_validation.nil?
        invalid_properties.push('invalid value for "force_secure_card_validation", force_secure_card_validation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enable_secure_card_validation.nil?
      return false if @force_secure_card_validation.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable == o.enable &&
          enable_secure_card_validation == o.enable_secure_card_validation &&
          force_secure_card_validation == o.force_secure_card_validation
    end
    ...
    def hash
      [enable, enable_secure_card_validation, force_secure_card_validation].hash
    end
