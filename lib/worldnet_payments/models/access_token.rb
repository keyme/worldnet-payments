...
module WorldnetPayments
  class AccessToken
    ...
    # Alias of the Merchant API Key to which the access token is bound
    ...
    # Number of hours after which the token will be expired
    attr_accessor :expires_in

    # Indicates whether transaction responses should contains the cardholder and merchant receipt copies
    attr_accessor :enable_receipts

    # Indicates whether responses should contains hypermedia links
    attr_accessor :enable_hypermedia

    # Set of roles with which the token was granted
    attr_accessor :roles

    # Set of terminal numbers with which the token is allowed to operate
    attr_accessor :allowed_terminals
    ...
    def self.openapi_types
      {
        ...
        :'enable_hypermedia' => :'Boolean',
        :'roles' => :'Array<String>',
        :'allowed_terminals' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::AccessToken` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::AccessToken`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enable_receipts')
        self.enable_receipts = attributes[:'enable_receipts']
      end

      if attributes.key?(:'enable_hypermedia')
        self.enable_hypermedia = attributes[:'enable_hypermedia']
      end
      ...
      if attributes.key?(:'allowed_terminals')
        if (value = attributes[:'allowed_terminals']).is_a?(Array)
          self.allowed_terminals = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @enable_receipts.nil?
        invalid_properties.push('invalid value for "enable_receipts", enable_receipts cannot be nil.')
      end

      if @enable_hypermedia.nil?
        invalid_properties.push('invalid value for "enable_hypermedia", enable_hypermedia cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enable_receipts.nil?
      return false if @enable_hypermedia.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] allowed_terminals Value to be assigned
    def allowed_terminals=(allowed_terminals)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_receipts == o.enable_receipts &&
          enable_hypermedia == o.enable_hypermedia &&
          roles == o.roles &&
          allowed_terminals == o.allowed_terminals
    end
    ...
    def hash
      [audience, bound_to, token_type, token, expires_in, enable_receipts, enable_hypermedia, roles, allowed_terminals].hash
    end
