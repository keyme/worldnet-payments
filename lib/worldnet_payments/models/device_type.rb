...
module WorldnetPayments
  class DeviceType
    ...
    # Company responsible for manufacturing the devices of this type.
    attr_accessor :manufacturer

    # Indicates whether this type of device is capable of performing card swipes.
    attr_accessor :supports_mag_stripe

    # Indicates whether this type of device is capable of reading card chips.
    attr_accessor :supports_icc

    # Indicates whether this type of device is capable of accepting keyed inputs.
    attr_accessor :supports_keyed

    # Indicates whether this type of device is capable of performing contactless transactions.
    attr_accessor :supports_contactless

    # Indicates whether this type of device is capable of accepting PIN entry.
    attr_accessor :supports_pin_entry

    # Indicates whether this type of device is capable of printing.
    attr_accessor :supports_output_printing

    # Indicates whether this type of device is capable of displaying information.
    attr_accessor :supports_output_displaying
    ...
    attr_accessor :default_emv_tags
    ...
    def self.openapi_types
      {
        :'type' => :'String',
        :'manufacturer' => :'String',
        :'supports_mag_stripe' => :'Boolean',
        :'supports_icc' => :'Boolean',
        :'supports_keyed' => :'Boolean',
        :'supports_contactless' => :'Boolean',
        :'supports_pin_entry' => :'Boolean',
        :'supports_output_printing' => :'Boolean',
        :'supports_output_displaying' => :'Boolean',
        :'applications' => :'Array<EmvApplication>',
        :'certificates' => :'Array<EmvCertificate>',
        :'revoked_certificates' => :'Array<EmvCertificate>',
        :'default_emv_tags' => :'Array<EmvTag>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WorldnetPayments::DeviceType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WorldnetPayments::DeviceType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'supports_mag_stripe')
        self.supports_mag_stripe = attributes[:'supports_mag_stripe']
      end

      if attributes.key?(:'supports_icc')
        self.supports_icc = attributes[:'supports_icc']
      end

      if attributes.key?(:'supports_keyed')
        self.supports_keyed = attributes[:'supports_keyed']
      end

      if attributes.key?(:'supports_contactless')
        self.supports_contactless = attributes[:'supports_contactless']
      end

      if attributes.key?(:'supports_pin_entry')
        self.supports_pin_entry = attributes[:'supports_pin_entry']
      end

      if attributes.key?(:'supports_output_printing')
        self.supports_output_printing = attributes[:'supports_output_printing']
      end

      if attributes.key?(:'supports_output_displaying')
        self.supports_output_displaying = attributes[:'supports_output_displaying']
      end
      ...
      if attributes.key?(:'revoked_certificates')
        if (value = attributes[:'revoked_certificates']).is_a?(Array)
          self.revoked_certificates = value
        end
      end

      if attributes.key?(:'default_emv_tags')
        if (value = attributes[:'default_emv_tags']).is_a?(Array)
          self.default_emv_tags = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@manufacturer.nil? && @manufacturer.to_s.length > 24
        invalid_properties.push('invalid value for "manufacturer", the character length must be smaller than or equal to 24.')
      end

      if !@manufacturer.nil? && @manufacturer.to_s.length < 0
        invalid_properties.push('invalid value for "manufacturer", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@manufacturer.nil? && @manufacturer.to_s.length > 24
      return false if !@manufacturer.nil? && @manufacturer.to_s.length < 0
      true
    end
    ...
    def manufacturer=(manufacturer)
      if !manufacturer.nil? && manufacturer.to_s.length > 24
        fail ArgumentError, 'invalid value for "manufacturer", the character length must be smaller than or equal to 24.'
      end

      if !manufacturer.nil? && manufacturer.to_s.length < 0
        fail ArgumentError, 'invalid value for "manufacturer", the character length must be great than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supports_mag_stripe == o.supports_mag_stripe &&
          supports_icc == o.supports_icc &&
          supports_keyed == o.supports_keyed &&
          supports_contactless == o.supports_contactless &&
          supports_pin_entry == o.supports_pin_entry &&
          supports_output_printing == o.supports_output_printing &&
          supports_output_displaying == o.supports_output_displaying &&
          applications == o.applications &&
          certificates == o.certificates &&
          revoked_certificates == o.revoked_certificates &&
          default_emv_tags == o.default_emv_tags
    end
    ...
    def hash
      [type, manufacturer, supports_mag_stripe, supports_icc, supports_keyed, supports_contactless, supports_pin_entry, supports_output_printing, supports_output_displaying, applications, certificates, revoked_certificates, default_emv_tags].hash
    end
