...
module WorldnetPayments
  class RefundsApi
    ...
    # @return [Refund]
    def get_refund(unique_reference, opts = {})
      data, _status_code, _headers = get_refund_with_http_info(unique_reference, opts)
      data
    end
    ...
    def get_refund_with_http_info(unique_reference, opts = {})
      ...
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling RefundsApi.get_refund"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.get_refund, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.get_refund, the character length must be great than or equal to 10.'
      end

      # resource path
      local_var_path = '/api/v1/transaction/refunds/{uniqueReference}'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Refund]
    def reverse_refund(unique_reference, opts = {})
      data, _status_code, _headers = reverse_refund_with_http_info(unique_reference, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Refund, Integer, Hash)>] Refund data, response status code and response headers
    def reverse_refund_with_http_info(unique_reference, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.reverse_refund ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling RefundsApi.reverse_refund"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.reverse_refund, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.reverse_refund, the character length must be great than or equal to 10.'
      end

      # resource path
      local_var_path = '/api/v1/transaction/refunds/{uniqueReference}/reverse'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
      ...
      new_options = opts.merge(
        :operation => :"RefundsApi.reverse_refund",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#reverse_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Refund]
    def unreferenced_refund(refund_request, opts = {})
      data, _status_code, _headers = unreferenced_refund_with_http_info(refund_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Refund, Integer, Hash)>] Refund data, response status code and response headers
    def unreferenced_refund_with_http_info(refund_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.unreferenced_refund ...'
      end
      # verify the required parameter 'refund_request' is set
      if @api_client.config.client_side_validation && refund_request.nil?
        fail ArgumentError, "Missing the required parameter 'refund_request' when calling RefundsApi.unreferenced_refund"
      end
      # resource path
      local_var_path = '/api/v1/transaction/refunds'
      ...
      new_options = opts.merge(
        :operation => :"RefundsApi.unreferenced_refund",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#unreferenced_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Refund]
    def update_refund(unique_reference, update_refund_request, opts = {})
      data, _status_code, _headers = update_refund_with_http_info(unique_reference, update_refund_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Refund, Integer, Hash)>] Refund data, response status code and response headers
    def update_refund_with_http_info(unique_reference, update_refund_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.update_refund ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling RefundsApi.update_refund"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.update_refund, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling RefundsApi.update_refund, the character length must be great than or equal to 10.'
      end
