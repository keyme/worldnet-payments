...
module WorldnetPayments
  class CredentialsApi
    ...
    # @param terminal [String] Unique number assigned by the gateway.
    # @param merchant_reference [String] Unique merchant reference that identifies the stored credentials on both merchant&#39;s and gateway&#39;s sides.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_credentials(terminal, merchant_reference, opts = {})
      delete_credentials_with_http_info(terminal, merchant_reference, opts)
      nil
    end
    ...
    def delete_credentials_with_http_info(terminal, merchant_reference, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CredentialsApi.delete_credentials ...'
      end
      # verify the required parameter 'terminal' is set
      if @api_client.config.client_side_validation && terminal.nil?
        fail ArgumentError, "Missing the required parameter 'terminal' when calling CredentialsApi.delete_credentials"
      end
      if @api_client.config.client_side_validation && terminal.to_s.length > 50
        fail ArgumentError, 'invalid value for "terminal" when calling CredentialsApi.delete_credentials, the character length must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && terminal.to_s.length < 1
        fail ArgumentError, 'invalid value for "terminal" when calling CredentialsApi.delete_credentials, the character length must be great than or equal to 1.'
      end

      # verify the required parameter 'merchant_reference' is set
      if @api_client.config.client_side_validation && merchant_reference.nil?
        fail ArgumentError, "Missing the required parameter 'merchant_reference' when calling CredentialsApi.delete_credentials"
      end
      if @api_client.config.client_side_validation && merchant_reference.to_s.length > 48
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.delete_credentials, the character length must be smaller than or equal to 48.'
      end

      if @api_client.config.client_side_validation && merchant_reference.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.delete_credentials, the character length must be great than or equal to 1.'
      end

      # resource path
      local_var_path = '/api/v1/customer/credentials/{merchantReference}'.sub('{' + 'merchantReference' + '}', CGI.escape(merchant_reference.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CredentialsApi.delete_credentials",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CredentialsApi#delete_credentials\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_credentials(terminal, merchant_reference, opts = {})
      data, _status_code, _headers = get_credentials_with_http_info(terminal, merchant_reference, opts)
      data
    end
    ...
    # @param merchant_reference [String] Unique merchant reference that identifies the stored credentials on both merchant&#39;s and gateway&#39;s sides.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecureCredentials, Integer, Hash)>] SecureCredentials data, response status code and response headers
    def get_credentials_with_http_info(terminal, merchant_reference, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CredentialsApi.get_credentials ...'
      end
      # verify the required parameter 'terminal' is set
      if @api_client.config.client_side_validation && terminal.nil?
        fail ArgumentError, "Missing the required parameter 'terminal' when calling CredentialsApi.get_credentials"
      end
      if @api_client.config.client_side_validation && terminal.to_s.length > 50
        fail ArgumentError, 'invalid value for "terminal" when calling CredentialsApi.get_credentials, the character length must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && terminal.to_s.length < 1
        fail ArgumentError, 'invalid value for "terminal" when calling CredentialsApi.get_credentials, the character length must be great than or equal to 1.'
      end

      # verify the required parameter 'merchant_reference' is set
      if @api_client.config.client_side_validation && merchant_reference.nil?
        fail ArgumentError, "Missing the required parameter 'merchant_reference' when calling CredentialsApi.get_credentials"
      end
      if @api_client.config.client_side_validation && merchant_reference.to_s.length > 48
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.get_credentials, the character length must be smaller than or equal to 48.'
      end

      if @api_client.config.client_side_validation && merchant_reference.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.get_credentials, the character length must be great than or equal to 1.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SecureCredentials'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Bearer']

      new_options = opts.merge(
        :operation => :"CredentialsApi.get_credentials",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CredentialsApi#get_credentials\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param search_credential_transactions_request [SearchCredentialTransactionsRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def search_credential_transactions(search_credential_transactions_request, opts = {})
      data, _status_code, _headers = search_credential_transactions_with_http_info(search_credential_transactions_request, opts)
      data
    end
    ...
    def search_credential_transactions_with_http_info(search_credential_transactions_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CredentialsApi.search_credential_transactions ...'
      end
      # verify the required parameter 'search_credential_transactions_request' is set
      if @api_client.config.client_side_validation && search_credential_transactions_request.nil?
        fail ArgumentError, "Missing the required parameter 'search_credential_transactions_request' when calling CredentialsApi.search_credential_transactions"
      end
      # resource path
      local_var_path = '/api/v1/customer/credentials/transactions'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(search_credential_transactions_request)
      ...
      new_options = opts.merge(
        :operation => :"CredentialsApi.search_credential_transactions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CredentialsApi#search_credential_transactions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param store_credentials_request [StoreCredentialsRequest] 
    # @param [Hash] opts the optional parameters
    # @return [SecureCredentials]
    def store_credentials(store_credentials_request, opts = {})
      data, _status_code, _headers = store_credentials_with_http_info(store_credentials_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecureCredentials, Integer, Hash)>] SecureCredentials data, response status code and response headers
    def store_credentials_with_http_info(store_credentials_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CredentialsApi.store_credentials ...'
      end
      # verify the required parameter 'store_credentials_request' is set
      if @api_client.config.client_side_validation && store_credentials_request.nil?
        fail ArgumentError, "Missing the required parameter 'store_credentials_request' when calling CredentialsApi.store_credentials"
      end
      # resource path
      local_var_path = '/api/v1/customer/credentials'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(store_credentials_request)
      ...
      new_options = opts.merge(
        :operation => :"CredentialsApi.store_credentials",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CredentialsApi#store_credentials\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param merchant_reference [String] Unique merchant reference that identifies the stored credentials on both merchant&#39;s and gateway&#39;s sides.
    # @param update_credentials_request [UpdateCredentialsRequest] 
    # @param [Hash] opts the optional parameters
    # @return [SecureCredentials]
    def update_credentials(merchant_reference, update_credentials_request, opts = {})
      data, _status_code, _headers = update_credentials_with_http_info(merchant_reference, update_credentials_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecureCredentials, Integer, Hash)>] SecureCredentials data, response status code and response headers
    def update_credentials_with_http_info(merchant_reference, update_credentials_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CredentialsApi.update_credentials ...'
      end
      # verify the required parameter 'merchant_reference' is set
      if @api_client.config.client_side_validation && merchant_reference.nil?
        fail ArgumentError, "Missing the required parameter 'merchant_reference' when calling CredentialsApi.update_credentials"
      end
      if @api_client.config.client_side_validation && merchant_reference.to_s.length > 48
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.update_credentials, the character length must be smaller than or equal to 48.'
      end

      if @api_client.config.client_side_validation && merchant_reference.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_reference" when calling CredentialsApi.update_credentials, the character length must be great than or equal to 1.'
      end

      # verify the required parameter 'update_credentials_request' is set
      if @api_client.config.client_side_validation && update_credentials_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_credentials_request' when calling CredentialsApi.update_credentials"
      end
      # resource path
      local_var_path = '/api/v1/customer/credentials/{merchantReference}'.sub('{' + 'merchantReference' + '}', CGI.escape(merchant_reference.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_credentials_request)
      ...
      new_options = opts.merge(
        :operation => :"CredentialsApi.update_credentials",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CredentialsApi#update_credentials\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
