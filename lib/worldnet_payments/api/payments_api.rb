...
module WorldnetPayments
  class PaymentsApi
    ...
    # @param unique_reference [String] Unique reference number assigned by the gateway.
    # @param capture_payment_request [CapturePaymentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Payment]
    def capture_payment(unique_reference, capture_payment_request, opts = {})
      data, _status_code, _headers = capture_payment_with_http_info(unique_reference, capture_payment_request, opts)
      data
    end
    ...
    def capture_payment_with_http_info(unique_reference, capture_payment_request, opts = {})
      ...
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling PaymentsApi.capture_payment"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.capture_payment, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.capture_payment, the character length must be great than or equal to 10.'
      end
      ...
      # resource path
      local_var_path = '/api/v1/transaction/payments/{uniqueReference}/capture'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Payment]
    def get_payment(unique_reference, opts = {})
      data, _status_code, _headers = get_payment_with_http_info(unique_reference, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Payment, Integer, Hash)>] Payment data, response status code and response headers
    def get_payment_with_http_info(unique_reference, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.get_payment ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling PaymentsApi.get_payment"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.get_payment, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.get_payment, the character length must be great than or equal to 10.'
      end

      # resource path
      local_var_path = '/api/v1/transaction/payments/{uniqueReference}'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
    ...
    # @param payment_request [PaymentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Payment]
    def payment(payment_request, opts = {})
      data, _status_code, _headers = payment_with_http_info(payment_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Payment, Integer, Hash)>] Payment data, response status code and response headers
    def payment_with_http_info(payment_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.payment ...'
      end
      # verify the required parameter 'payment_request' is set
      if @api_client.config.client_side_validation && payment_request.nil?
        fail ArgumentError, "Missing the required parameter 'payment_request' when calling PaymentsApi.payment"
      end
      # resource path
      local_var_path = '/api/v1/transaction/payments'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Refund]
    def refund_payment(unique_reference, refund_payment_request, opts = {})
      data, _status_code, _headers = refund_payment_with_http_info(unique_reference, refund_payment_request, opts)
      data
    end
    ...
    def refund_payment_with_http_info(unique_reference, refund_payment_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.refund_payment ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling PaymentsApi.refund_payment"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.refund_payment, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.refund_payment, the character length must be great than or equal to 10.'
      end
      ...
      # resource path
      local_var_path = '/api/v1/transaction/payments/{uniqueReference}/refunds'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
    ...
    # @param unique_reference [String] Unique reference number assigned by the gateway.
    # @param [Hash] opts the optional parameters
    # @option opts [ReversePaymentRequest] :reverse_payment_request 
    # @return [Payment]
    def reverse_payment(unique_reference, opts = {})
      data, _status_code, _headers = reverse_payment_with_http_info(unique_reference, opts)
      data
    end
    ...
    # @option opts [ReversePaymentRequest] :reverse_payment_request 
    # @return [Array<(Payment, Integer, Hash)>] Payment data, response status code and response headers
    def reverse_payment_with_http_info(unique_reference, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.reverse_payment ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling PaymentsApi.reverse_payment"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.reverse_payment, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.reverse_payment, the character length must be great than or equal to 10.'
      end

      # resource path
      local_var_path = '/api/v1/transaction/payments/{uniqueReference}/reverse'.sub('{' + 'uniqueReference' + '}', CGI.escape(unique_reference.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'reverse_payment_request'])
      ...
      new_options = opts.merge(
        :operation => :"PaymentsApi.reverse_payment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#reverse_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Payment]
    def update_payment(unique_reference, update_payment_request, opts = {})
      data, _status_code, _headers = update_payment_with_http_info(unique_reference, update_payment_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Payment, Integer, Hash)>] Payment data, response status code and response headers
    def update_payment_with_http_info(unique_reference, update_payment_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.update_payment ...'
      end
      # verify the required parameter 'unique_reference' is set
      if @api_client.config.client_side_validation && unique_reference.nil?
        fail ArgumentError, "Missing the required parameter 'unique_reference' when calling PaymentsApi.update_payment"
      end
      if @api_client.config.client_side_validation && unique_reference.to_s.length > 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.update_payment, the character length must be smaller than or equal to 10.'
      end

      if @api_client.config.client_side_validation && unique_reference.to_s.length < 10
        fail ArgumentError, 'invalid value for "unique_reference" when calling PaymentsApi.update_payment, the character length must be great than or equal to 10.'
      end
